# Generated by Django 5.1.1 on 2024-10-09 13:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_gender', models.CharField(choices=[('M', 'MAN'), ('W', 'WOMEN')], max_length=1)),
                ('customer_email', models.EmailField(max_length=254, unique=True)),
                ('customer_phone', models.IntegerField(max_length=12)),
                ('customer_address', models.TextField()),
                ('customer_profile_picture', models.ImageField(upload_to='')),
